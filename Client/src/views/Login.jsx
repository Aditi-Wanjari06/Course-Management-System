...
//         localStorage.setItem("user", JSON.stringify(response.data.message)); //object
//       } else {
...
//       }}
//     >
//       <div className="drop-shadow-2xl w-[500px] px-12 py-8 bg-white rounded-xl">
//         <h2 className="text-center text-2xl font-bold mb-2 ">Sign In</h2>
//         <p className="text-center text-base text-black/60 mb-6">
//           Don't have an account?&nbsp;
//           <Link
//             to="/signup"
//             className="font-medium hover:text-blue-800 animate-pulse"
//           >
//             Sign Up
//           </Link>
//         </p>
...
//             <div className="text-end text-blue-600 cursor-pointer">
//               <p>Forgot Password</p>
//             </div>

//             <Button
//               className="bg-red-600 text-white py-1.5 px-7 rounded-lg duration-300 mt-4"
//               type="submit"
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setTimeout(() => handleDashboard(), 1200);
