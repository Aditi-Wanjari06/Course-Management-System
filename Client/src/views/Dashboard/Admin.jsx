...
//     title: "Teachers",
//     value: 67,
//     icon: <UserCircleIcon className="h-10 w-10 text-green-500" />,
//   },
//   {
//     title: "Courses",
//     value: 32,
...
//               <div
//                 key={index}
//                 className="bg-white w-72 rounded-2xl shadow-md p-5 flex items-center justify-between gap-4 hover:shadow-lg transition border-2 border-orange-300 hover:bg-orange-50"
//               >
//                 {card.icon} 
//                 <div className="flex-flex-col items-center">
//                   <p className="text-gray-600 text-2xl font-serif">{card.title}</p>
...
//               <button className="bg-blue-600 text-white py-3 px-4 rounded-xl hover:bg-blue-700"
...
//                 Teacher Dashboard
//               </button>
//               <button className="bg-purple-600 text-white py-3 px-4 rounded-xl hover:bg-purple-700"
