...
//       <div
//         className="shadow-md shadow-blue-50 flex flex-col justify-center items-center w-80 px-6 py-5 rounded-lg gap-3 
//     relative z-10 bg-white/90 backdrop-blur-md"
//       >
//         <div className="border-b-2  border-black w-64 text-center py-1">
//           <p className="text-3xl font-semibold mb-2">Sign Out</p>
//         </div>
//         <div className="mb-2">
//           <p className="text-lg ">Are you sure?</p>
//         </div>
//         <div className="flex flex-row gap-4 text-white">
//           <Button className="bg-green-500 hover:bg-green-200" onClick={handleYesButton}>
//             Yes
//           </Button>

//           <Button className="bg-red-500 hover:bg-red-200" onClick={handleNoButton}>
//             No
//           </Button>
//         </div>
//       </div>
