...
//         <Sidenavbar />
//         <div className="w-full mx-auto p-4 shadow-lg rounded-lg bg-white my-7">
...
//           border border-blue-300 hover:shadow-md hover:shadow-blue-300 
...
//             {/* TITLE */}
//             <div>
//               <label className="text-sm font-semibold text-blue-800 mb-1 flex items-center gap-2">
...
//                 font-semibold text-lg shadow-sm shadow-blue-300
