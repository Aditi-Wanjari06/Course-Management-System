...
//         <div className={`w-64 flex flex-col items-center m-2 p-5  gap-3 rounded-xl bg-white cursor-pointer shadow-md shadow-blue-200 hover:bg-orange-100 border-2 border-orange-300 
            
//         ${className}`}{...props}>
//             <img src={image} alt='icon' className='h-20' />
//             <p className='text-lg font-semibold text-center mt-4 font-serif text-orange-900 hover:text-orange-600'>{title}</p>
